...
<html>
	...
	<body>
		<div class="container-fluid">
			...
			<?php endif; ?>
			<div class="row-fluid">
				<form action="index.php?option=plg_system_jinboundsalesforce&amp;view=upload" class="form-vertical" id="wsdlForm" method="post" enctype="multipart/form-data">
					<fieldset>
						<legend><?php echo JText::_('PLG_SYSTEM_JINBOUNDSALESFORCE_UPLOAD_WSDL'); ?></legend>
						<div class="control-group">
							<div class="control-label">
								<label for="jinboundsalesforcefile"><?php echo JText::_('PLG_SYSTEM_JINBOUNDSALESFORCE_FILE'); ?></label>
							</div>
							<div class="controls">
