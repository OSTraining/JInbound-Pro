...
{
	var $_extensionName			= 'plg_system_jinboundfiles';
	var $_extensionTitle		= 'System - JInbound Files';
	...
	var $_storageConfig			= array(
		'extensionName'	=> 'plg_system_jinboundfiles',
		'key'			=> 'liveupdate'
	);
	...
	public function __construct()
	{
		...
		$json = $db->setQuery($db->getQuery(true)
			...
			->where($db->quoteName('element') . ' = ' . $db->quote('jinboundfiles'))
		)->loadResult();
