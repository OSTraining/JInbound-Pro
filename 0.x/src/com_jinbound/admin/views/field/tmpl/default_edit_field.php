...
<div class="well row-fluid">
	...
	<ul class="unstyled">
		...
		<li><span class="label">colors</span> comma separated list of colors, only used when <span class="label">control</span> = "simple"</li>
		<li><span class="label">split</span> number of colors before each split, default 5, only used when <span class="label">control</span> = "simple"</li>
		<li><span class="label">onchange</span> javascript onchange</li>
		<li><span class="label">autofocus</span> automatically focus this element</li>
	</ul>
