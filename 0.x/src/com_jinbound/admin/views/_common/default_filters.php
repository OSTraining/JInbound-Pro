...
<fieldset id="filter-bar">
	<div class="filter-search fltlft btn-group pull-left">
		...
		<input type="text" name="filter_search" id="filter_search" value="<?php echo JInboundHelperFilter::escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_JINBOUND_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_JINBOUND_FILTER_SEARCH_DESC'); ?>" />
