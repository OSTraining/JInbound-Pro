 ...
 * component    string    The name of the component which will store our data. If not specified the extension name will
 * be used. key            string    The name of the component parameter where the serialized data will be stored. If
 * not specified "liveupdate" will be used.
 */
