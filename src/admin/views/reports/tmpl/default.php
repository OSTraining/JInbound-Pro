...
<div class="container-fluid <?php echo $this->viewClass; ?>" id="jinbound_component">
    ...
    <div id="j-main-container" class="span10">
        ...
        <div id="j-main-container">
            ...
            <form action="<?php echo JInboundHelperUrl::view('reports'); ?>" method="post" id="adminForm"
                  name="adminForm" class="form-validate" enctype="multipart/form-data">
                <div class="row-fluid">
                    <div class="span12 text-center">
                        <div class="reports_search">
                            ...
                            <?php echo JHtml::_('calendar', $this->state->get('filter_start'), 'filter_start',
                            ...
                            <?php echo JHtml::_('calendar', $this->state->get('filter_end'), 'filter_end', 'filter_end',
                                '%Y-%m-%d', array(
                                    'size'        => 10
                                ,
