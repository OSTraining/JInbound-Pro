...
class LiveUpdateFetch extends JObject
{
     ...
     *
     * @return int 0 = no updates, 1 = updates available, -1 = updates not supported, -2 = fetching updates crashes the
     *             server
     */
    ...
    private function fetchCURL()
    {
        ...
        curl_setopt($process, CURLOPT_USERAGENT,
            'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.2.14) Gecko/20110105 Firefox/3.6.14');
