...
$userId     = $user->get('id');
$canCheckin = $user->authorise('core.manage', 'com_checkin') || $this->currentItem->checked_out == $userId || $this->currentItem->checked_out == 0;
...
$canEditOwn = $user->authorise('core.edit.own', JInbound::COM.".$itemName") && $this->currentItem->created_by == $userId && $canCheckin;
