            ...
            <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span12 well">
                        <div class="row-fluid">
                            <div class="pull-right"><?php echo JText::sprintf('COM_JINBOUND_USER_ID',
                                    $this->item->contact_id); ?></div>
                        </div>
                        <div class="row-fluid">
                            <?php
                                    ...
                                    <?php if (!empty($this->item->_formdatas)) : ?>
                                        <?php foreach ($this->item->_formdatas as $i => $data) : ?>
                                            <?php echo JHtml::_('jinbound.addSlide', 'leadSlider',
                                                $data['created'] . ' | ' . $data['pagename'], 'leadslider-' . $i); ?>
                                            ...
                                            <?php if (!empty($this->campaign->emails)) : ?>
                                                <table class="table table-striped">
                                                    <?php foreach ($this->campaign->emails as $email) : ?>
                                                        <tr>
                                                            <td><a href="<?php echo JInboundHelperUrl::edit('email',
                                                                    $email->id); ?>"><?php echo $this->escape($email->version_subject); ?></a>
                                                            </td>
